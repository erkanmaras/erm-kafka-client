...
/// </summary>
public class KafkaMessageHeaders : IKafkaMessageHeaders
{
    private readonly Headers _headers;

    /// <summary>
    ///     Initializes a new instance of the <see cref="KafkaMessageHeaders" /> class.
    /// </summary>
    /// <param name="headers">The Confluent headers</param>
    public KafkaMessageHeaders(Headers headers)
    {
        _headers = headers;
    }
    ...
    ///     Initializes a new instance of the <see cref="KafkaMessageHeaders" /> class.
    /// </summary>
    public KafkaMessageHeaders() : this(new Headers())
    {
    }
