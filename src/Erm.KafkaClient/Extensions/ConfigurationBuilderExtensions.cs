...
/// <summary>
///     Provides extension methods over <see cref="IConsumerConfigurationBuilder" /> and
///     <see cref="IProducerConfigurationBuilder" />
/// </summary>
public static class ConfigurationBuilderExtensions
{
    ...
    ///     <see cref="P:Confluent.Kafka.CompressionType" /> enum to select the compression codec to use for compressing
    ///     message sets. This is the default value for all topics, may be overridden by the topic configuration property
    ///     `compression.codec`.
    ///     default: none
    ///     importance: medium
    /// </param>
    ...
    ///     values will result in better compression at the cost of more CPU usage. Usable range is algorithm-dependent: [0-9]
    ///     for gzip; [0-12] for lz4; only 0 for snappy; -1 = codec-dependent default compression level.
    ///     default: -1
    ///     importance: medium
    /// </param>
    /// <returns></returns>
    ...
    public static IConsumerConfigurationBuilder WithCustomFactory(
        this IConsumerConfigurationBuilder builder,
        ConsumerFactory decoratorFactory)
    {
    ...
    public static IProducerConfigurationBuilder WithCustomFactory(
        this IProducerConfigurationBuilder builder,
        ProducerFactory decoratorFactory)
    {
